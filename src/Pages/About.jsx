...
const features = [
  {
    icon: <FaCouch className="text-yellow-400 text-4xl" />,
    title: "Premium Furniture",
    desc: "Crafted with top-quality materials to blend comfort and durability.",
  },
  {
    icon: <FaDoorOpen className="text-yellow-400 text-4xl" />,
    title: "Stylish Doors",
    ...
    <div className="p-10 text-white bg-gradient-to-br from-gray-800 to-black min-h-screen mt-20">
      ...
      >
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-300">
          Funi Company specializes in premium furniture and stylish doors crafted
          for modern living. Our mission is to bring elegance, comfort, and
          security to every home.
        </p>
      </motion.div>
      ...
      <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        {features.map((feature, index) => (
          <motion.div
            key={index}
            className="bg-gray-900 p-6 rounded-2xl shadow-lg text-center hover:scale-105 transition"
      ...
      <div className="mt-16 max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {articles.map((article, idx) => (
            <motion.div
              key={idx}
              className="bg-gray-900 p-6 rounded-xl shadow-md hover:bg-gray-800 transition"
